...
var cProductNumber = vGoogleTable.GoogleTableProduct.AddGridColumn("ProductNumber", "GoogleExtension.GoogleColumn");
cProductNumber.Value.BindData(vGoogleTable.GoogleTableProduct.DataSource.ProductNumber);
var cSafetyStockLevel = vGoogleTable.GoogleTableProduct.AddGridColumn("SafetyStockLevel", "GoogleExtension.GoogleColumn");
cSafetyStockLevel.Value.BindData(vGoogleTable.GoogleTableProduct.DataSource.SafetyStockLevel);
var cSize = vGoogleTable.GoogleTableProduct.AddGridColumn("Size", "GoogleExtension.GoogleColumn");
cSize.Value.BindData(vGoogleTable.GoogleTableProduct.DataSource.Size);
var cSizeUnitMeasureCode = vGoogleTable.GoogleTableProduct.AddGridColumn("SizeUnitMeasureCode", "GoogleExtension.GoogleColumn");
cSizeUnitMeasureCode.Value.BindData(vGoogleTable.GoogleTableProduct.DataSource.SizeUnitMeasureCode);
var cSellStartDate = vGoogleTable.GoogleTableProduct.AddGridColumn("SellStartDate", "GoogleExtension.GoogleColumn");
cSellStartDate.Value.BindData(vGoogleTable.GoogleTableProduct.DataSource.SellStartDate);
var cSellEndDate = vGoogleTable.GoogleTableProduct.AddGridColumn("SellEndDate", "GoogleExtension.GoogleColumn");
