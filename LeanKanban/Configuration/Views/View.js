...
mainControl.Boards.click.BindCommand(aas.Services.Browser.UIService.ShowView(aas.ViewName.MainContent));

var mainContent = Aspectize.CreateView("MainContent", aas.Controls.MainContent, aas.Zones.MainControl.Content, true);
mainContent.OnLoad.BindCommand(aas.Services.Server.LoadDataService.LoadBoards(), aas.Data.MainData, true);

mainContent.BtnNewBoard.click.BindCommand(aas.Services.Browser.ClientService.ShowModal(aas.ViewName.EditBoard));
mainContent.BtnNewBoard.click.BindCommand(aas.Services.Browser.DataService.AddRowAndSelect(aas.Path.MainData.Board));

var boardItem = Aspectize.CreateRepeatedView("BoardItem", aas.Controls.BoardItem, aas.Zones.MainContent.RepeaterPanelBoard, aas.Data.MainData.Board);
...
boardItem.BoardItem.click.BindCommand(aas.Services.Browser.UIService.ShowView(aas.ViewName.Board));

var board = Aspectize.CreateView("Board", aas.Controls.Board, aas.Zones.MainControl.Content, false, aas.Data.MainData.Board);
board.BtnNewState.click.BindCommand(aas.Services.Browser.ClientService.ShowModal(aas.ViewName.EditState));
...
editBoard.Cancel.click.BindCommand(aas.Services.Browser.ClientService.CloseModal(aas.ViewName.EditBoard));
...
editBoard.Save.click.BindCommand(aas.Services.Browser.ClientService.CloseModal(aas.ViewName.EditBoard));
...
editState.Cancel.click.BindCommand(aas.Services.Browser.ClientService.CloseModal(aas.ViewName.EditState));
...
vEditWorkItem.Cancel.click.BindCommand(aas.Services.Browser.ClientService.CloseModal(aas.ViewName.EditWorkItem));
